...
class ejemplo_4_10Test {
    ...
    void testCalcTotalAnio4() {
        assertEquals(300.0, m3d.calcTotalAnio4(metTest), 0.001);
    }

    @Test
    void testCalcTotalEst17Anio5() {
        assertEquals(30.0, m3d.calcTotalEst17Anio5(metTest), 0.001);
    }

    @Test
    void testCalcGranTotal() {
        // Suma todos los elementos. En nuestro test, es 30 + 300 = 330
        assertEquals(330.0, m3d.calcGranTotal(metTest), 0.001);
    }
}